    ...
    const fetchAllData = async () => {
      try {
        const [waikaneRes, waiaholeRes, punaluuRes, tideRes, rainRes] = await Promise.all([
          fetch('http://159.223.179.149:5000/api/waikane_stream'),
          fetch('http://159.223.179.149:5000/api/waiahole_stream'),
          fetch('http://159.223.179.149:5000/api/punaluu_stream'),
