...
const WaiaholeStreamGraph = () => {
  ...
  // Threshold lines - specific to Waiahole Stream (12ft and 16.4ft)
  const threshold1Y = padding + ((yMax - 12) / yRange) * graphHeight;
  const threshold2Y = padding + ((yMax - 16.4) / yRange) * graphHeight;
      ...
      <View style={styles.chartContainer}>
        <Svg width={chartWidth} height={chartHeight}>
          ...
          <Path
            ...
            fill="url(#waiaholeStreamGradient)"
          />
