...
const PunaluuStreamGraph = () => {
  ...
  // Y-axis range - specific to Punaluu Stream (same as PunaluuStreamHeight thresholds)
  const yMin = 0;
  const yMax = 16;
  ...
  // Threshold lines - specific to Punaluu Stream (10ft and 14.7ft)
  const threshold1Y = padding + ((yMax - 10) / yRange) * graphHeight;
  const threshold2Y = padding + ((yMax - 14.7) / yRange) * graphHeight;
...
export default PunaluuStreamGraph;
