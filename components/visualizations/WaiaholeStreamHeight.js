  ...
  return (
    <ZoomableChart
      ...
      renderZoomContent={({ width, height }) => (
        <WaiaholeStreamGraph streamData={streamData} width={width} height={height} />
      )}
    >
      <View style={styles.container}>
        ...
        <View style={styles.gaugeContainer}>
          <Svg width={700} height={300}>
            ...
            {[{ value: greenEnd, color: '#FFC107', label: '7.00 ft' }, { value: yellowEnd, color: '#F44336', label: '10.80 ft' }].map((threshold, idx) => {
